                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <motion.div variants={itemVariants} className="space-y-8">
                            ...
                            <div className="prose prose-invert">
                                ...
                                <p className="text-lg text-gray-300 leading-relaxed">
                                    I like to be a data engineer, and I love to play games. I think I can do everything
                                    a little bit, but I follow through,
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden ">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/0 to-black/0"></div>
                                <div
                                    className="absolute -top-4 -right-4 w-24 h-24 bg-pink-400/10 rounded-full blur-xl"></div>
                            </div>

                            <div
                                className="absolute -right-4 top-1/2 -translate-y-1/2 transform rotate-90 origin-right">
