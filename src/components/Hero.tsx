...
const Hero = () => {
  ...
  return (
      <section id="home" className="min-h-screen bg-black relative overflow-hidden ">
        ...
        {/* Custom Cursor */}
        <div className="custom-cursor fixed w-8 h-8 rounded-full pointer-events-none z-50 mix-blend-difference bg-gradient-to-r from-pink-400 to-purple-400 transform -translate-x-1/2 -translate-y-1/2 scale-50 transition-transform duration-200" />
      </section>
  );
};
